            ...
            <div className="relative w-full overflow-hidden rounded-2xl bg-primary shadow-xl sm:max-w-4xl">
              ...
              <div className="flex flex-col gap-4 px-4 pt-5 sm:px-6 sm:pt-6">
                <div className="relative w-max">
                  <FeaturedIcon color="success" size="lg" theme="light" icon={Target04} />
              ...
              {/* Scrollable Content */}
              <div className="max-h-[calc(90vh-10rem)] overflow-y-auto px-4 pt-4 sm:px-6">
              ...
              <div className="flex items-center gap-3 border-t border-secondary px-4 py-4 sm:px-6">
