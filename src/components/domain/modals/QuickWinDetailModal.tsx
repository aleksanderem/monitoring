                        ...
                        <div className="relative w-full overflow-hidden rounded-2xl bg-primary shadow-xl sm:max-w-4xl">
                            ...
                            <div className="flex flex-col gap-4 px-4 pt-5 sm:px-6 sm:pt-6">
                                <div className="relative w-max">
                                    <FeaturedIcon color="success" size="lg" theme="light" icon={Zap} />
                                    <BackgroundPattern pattern="circle" size="sm" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                                </div>
                                <div className="z-10 flex flex-col gap-0.5">
                                    <div className="flex items-center gap-3">
                                        <AriaHeading slot="title" className="text-md font-semibold text-primary truncate">
                            ...
                            <div className="max-h-[70vh] overflow-y-auto">
                                ...
                                {/* Footer */}
                                {plan && (
                                    <div className="sticky bottom-0 flex items-center justify-between gap-4 border-t border-secondary bg-primary px-4 py-3 sm:px-6">
